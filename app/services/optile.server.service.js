...
module.exports = function (app) {
    var service = {};
    service.list = function (country, customer, payment, callback) {

        service.listPost(country, customer, payment, function(err, data) {
    ...
    service.listPost = function (country, customer, payment, callback) {
        ...
        var post_req = https.request(endpoint, function (res) {
            app.logger.info("statusCode: ", res.statusCode);
